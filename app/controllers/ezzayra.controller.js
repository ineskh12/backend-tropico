const Ezzayra = require('../models/ezzayra.model.js');
...
// Create and Save a new  Ezzayra article
exports.create = async(req, res) => {
    
      const word = new Ezzayra({
...
// Retrieve and return all Ezzayra news from the database.
...
// Retrieve and return all the Ezzayra news from the database.
...
// Delete a News with the specified Ezzayra newsId in the request
exports.delete = async(req, res) => {
    Ezzayra.findByIdAndRemove(req.params.newsId)
    .then(word => {
        if(!word) {
            return res.status(404).send({
                message: "News not found with id " + req.params.newsId
...
exports.masquer = async(req, res) => {
    const news = await Ezzayra.findById(req.params.newsId);
